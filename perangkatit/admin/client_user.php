    ...
    <body>
        ...
        <div class="container-fluid">
            <div class="row-fluid">
				...
				<?php	
	             $count_user=mysqli_query($GLOBALS["___mysqli_ston"], "select * from client");
	             $count = mysqli_num_rows($count_user);
                 ?>	 
                        <div id="block_bg" class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left"><i class="icon-user"></i> Manager (s) List</div>
                            ...
                            <div class="block-content collapse in">
								...
								<form action="delete_client.php" method="post">
									...
									<?php include('modal_delete.php'); ?>
										...
										<tbody>
													<?php
													$user_query = mysqli_query($GLOBALS["___mysqli_ston"], "select * from client")or die(mysqli_error($GLOBALS["___mysqli_ston"]));
