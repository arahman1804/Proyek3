...
$query = mysqli_query($GLOBALS["___mysqli_ston"], "select * from stlocation where stdev_location_name  =  '$stdev_location_name' ")or die(mysqli_error($GLOBALS["___mysqli_ston"]));
...
mysqli_query($GLOBALS["___mysqli_ston"], "insert into stlocation (stdev_location_name,thumbnails) values('$stdev_location_name','images/thumbnails.jpg')")or die(mysqli_error($GLOBALS["___mysqli_ston"]));

mysqli_query($GLOBALS["___mysqli_ston"], "insert into activity_log (date,username,action) values(NOW(),'$admin_username','Add location $stdev_location_name')")or die(mysqli_error($GLOBALS["___mysqli_ston"]));
?>
<script>
