    ...
    <body>
        ...
        <div class="container-fluid">
            <div class="row-fluid">
				...
				<?php	
	             $count_dev_name=mysqli_query($GLOBALS["___mysqli_ston"], "select * from device_name");
                            ...
                            <div class="block-content collapse in">
								...
								<form action="delete_client.php" method="post">
									...
									<?php include('modal_delete.php'); ?>
										...
										<tbody>
													<?php
													$device_name_query = mysqli_query($GLOBALS["___mysqli_ston"], "select * from device_name")or die(mysqli_error($GLOBALS["___mysqli_ston"]));
