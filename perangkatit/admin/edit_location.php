                      ...
                      <div class="alert alert-success alert-dismissable">
                        ...
                        <div id="block_bg" class="block">
							...
							<div id="" class="muted pull-right">
								<?php 
								$my_location = mysqli_query($GLOBALS["___mysqli_ston"], "select * from stlocation ")or die(mysqli_error($GLOBALS["___mysqli_ston"]));
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
									...
									<thead>
										...
										<tbody>
										<?php
										$location_query = mysqli_query($GLOBALS["___mysqli_ston"], "select * from stlocation")or die(mysqli_error($GLOBALS["___mysqli_ston"]));
