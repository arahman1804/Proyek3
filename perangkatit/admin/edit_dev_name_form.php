	...
	$('#add').tooltip('hide');
                        ...
                        <div class="block">
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
								<?php
								$query = mysqli_query($GLOBALS["___mysqli_ston"], "select * from device_name where dev_id = '$get_id'")or die(mysqli_error($GLOBALS["___mysqli_ston"]));
...
mysqli_query($GLOBALS["___mysqli_ston"], "update device_name set dev_name = '$dev_name'  where dev_id = '$get_id' ")or die(mysqli_error($GLOBALS["___mysqli_ston"]));

mysqli_query($GLOBALS["___mysqli_ston"], "insert into activity_log (date,username,action) values(NOW(),'$admin_username','Edit Device Type $dev_name')")or die(mysqli_error($GLOBALS["___mysqli_ston"]));	
?>
<script>
