	               ...
	               <script type="text/javascript">
		              ...
		              $('#add').tooltip('hide');
                        ...
                        <div class="block">
							...
							<?php
							$query = mysqli_query($GLOBALS["___mysqli_ston"], "select * from stlocation where stdev_id = '$get_id'")or die(mysqli_error($GLOBALS["___mysqli_ston"]));
...
mysqli_query($GLOBALS["___mysqli_ston"], "update stlocation set stdev_location_name = '$stdev_location_name' where stdev_id = '$get_id' ")or die(mysqli_error($GLOBALS["___mysqli_ston"]));

mysqli_query($GLOBALS["___mysqli_ston"], "insert into activity_log (date,username,action) values(NOW(),'$admin_username','Edit location $stdev_location_name')")or die(mysqli_error($GLOBALS["___mysqli_ston"]));
?>
