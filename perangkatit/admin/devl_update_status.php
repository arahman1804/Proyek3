            ...
            <div class="row-fluid">
				<?php include('device_location_slidebar.php'); ?>
						...
						<div class="span9" id="content">
						    ...
						    <?php $location_query = mysqli_query($GLOBALS["___mysqli_ston"], "select * from stlocation	                     
	                         where stdev_id = '$stdev_id'")or die(mysqli_error($GLOBALS["___mysqli_ston"]));
									 ...
									 <form class="form-horizontal" method="post">
									   ...
									   <div class="control-group">
										...
										<div class="control-group">
											...
											<div class="controls">
											<select id="status" value="" name="dev_status" required>
										...
										<div id="ket" class="control-group">
											<label class="control-label" for="inputPassword"  placeholder="Device Status" >Keterangan Rusak</label>
											<div class="controls">
											<div>
  	 											<!--<textarea name="keterangan" rows="10" placeholder="Keterangan"></textarea>-->
												<select id="keterangan" name="keterangan">
  	 											<option value="ringan">Damage Ringan</option>
  	 											<option value="sedang">Damage Sedang</option>
  	 											<option value="berat">Damage Berat</option>
												</select>
  											</div>							
											</div>
										</div>
										...
										$dev_ket = $_POST['keterangan'];																
									
										mysqli_query($GLOBALS["___mysqli_ston"], "update stdevice set 
										            dev_id = '$dev_id',																		
													dev_status = '$dev_status',
													keterangan = '$dev_ket'
													where id = '$get_id' ")or die(mysqli_error($GLOBALS["___mysqli_ston"]));
													
										mysqli_query($GLOBALS["___mysqli_ston"], "insert into activity_log (date,username,action) values(NOW(),'$admin_username','Update Status $dev_name to $dev_status ')")or die(mysqli_error($GLOBALS["___mysqli_ston"]));			
										?>
										<script>
