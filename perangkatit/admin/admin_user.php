    ...
    <body>
        ...
        <div class="container-fluid">
            <div class="row-fluid">
				...
				<?php	
	             $count_user=mysqli_query($GLOBALS["___mysqli_ston"], "select * from admin");
                            ...
                            <div class="block-content collapse in">
								...
								<form action="delete_users.php" method="post">
									...
									<?php include('modal_delete.php'); ?>
										...
										<tbody>
													<?php
													$user_query = mysqli_query($GLOBALS["___mysqli_ston"], "select * from admin")or die(mysqli_error($GLOBALS["___mysqli_ston"]));
