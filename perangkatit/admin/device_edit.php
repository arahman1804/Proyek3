		                    ...
		                    <div class="row-fluid">
		                        ...
		                        <div id="" class="block">
									...
									?>
										...
										mysqli_query($GLOBALS["___mysqli_ston"], "update stdevice set dev_id = '$dev_id' ,
																		dev_desc = '$dev_desc',
										...
										mysqli_query($GLOBALS["___mysqli_ston"], "insert into activity_log (date,username,action) values(NOW(),'$admin_username',
										'Edit device info $dev_name')")or die(mysqli_error($GLOBALS["___mysqli_ston"]));
