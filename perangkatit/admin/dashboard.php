...
<div id="page-wrapper">
		...
		<?php 
		 ...
		 where dev_status='New'")or die(mysqli_error($GLOBALS["___mysqli_ston"]));
...
<div id="page-wrapper">
	     ...
	     LEFT JOIN device_name ON stdevice.dev_id=device_name.dev_id
		 where dev_status='Damage'")or die(mysqli_error($GLOBALS["___mysqli_ston"]));
		...
		<?php 
	     $Repaired = mysqli_query($GLOBALS["___mysqli_ston"], "select * from stdevice
	     LEFT JOIN device_name ON stdevice.dev_id=device_name.dev_id
		 where dev_status='Repaired'")or die(mysqli_error($GLOBALS["___mysqli_ston"]));
...
<div id="page-wrapper">
           <div class="row-fluid">
        <?php 
	     $dump = mysqli_query($GLOBALS["___mysqli_ston"], "select * from stdevice
	     LEFT JOIN device_name ON stdevice.dev_id=device_name.dev_id
		 where dev_status='Dump'")or die(mysqli_error($GLOBALS["___mysqli_ston"]));
		...
		<?php 
	     $location = mysqli_query($GLOBALS["___mysqli_ston"], "select * from stlocation")or die(mysqli_error($GLOBALS["___mysqli_ston"]));
