...
<?php 
mysqli_query($GLOBALS["___mysqli_ston"], "update stdevice set dev_status='Dump' where id = '$get_id'")or die(mysqli_error($GLOBALS["___mysqli_ston"]));
mysqli_query($GLOBALS["___mysqli_ston"], "insert into activity_log (date,username,action) values(NOW(),'$admin_username','Dump Device $dev_name Inventory Code:$dev_serial')")or die(mysqli_error($GLOBALS["___mysqli_ston"]));						
