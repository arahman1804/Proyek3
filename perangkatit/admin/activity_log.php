    ...
    <body>
        ...
        <div class="container-fluid">
            <div class="row-fluid">
				...
				<?php	
	             $count_log=mysqli_query($GLOBALS["___mysqli_ston"], "select * from activity_log");
                            ...
                            <div class="block-content collapse in">
								...
								<form action="delete_log.php" method="post">
									...
									<?php include('modal_delete.php'); ?>
                              		...
                              		<?php
										$query = mysqli_query($GLOBALS["___mysqli_ston"], "select * from  activity_log 
										LEFT JOIN admin ON activity_log.username = admin.username
										order by date DESC")or die(mysqli_error($GLOBALS["___mysqli_ston"]));
