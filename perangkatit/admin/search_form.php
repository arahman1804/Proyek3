...
<div class="modal-body">
    <form class="form-horizontal" method="post" action="advance_search.php">
			  ...
			  <?php
				$class_query = mysqli_query($GLOBALS["___mysqli_ston"], "select * from stlocation")or die(mysqli_error($GLOBALS["___mysqli_ston"]));
			  ...
			  <?php
				$serial_query = mysqli_query($GLOBALS["___mysqli_ston"], "select * from stdevice")or die(mysqli_error($GLOBALS["___mysqli_ston"]));
