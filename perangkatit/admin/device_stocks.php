    ...
    <body>
        ...
        <div class="container-fluid">
            <div class="row-fluid">
				...
				<?php	
	             $count_item=mysqli_query($GLOBALS["___mysqli_ston"], "select * from stdevice
...
<!-----------------------------------Content------------------------------------>
<?php
		$device_query = mysqli_query($GLOBALS["___mysqli_ston"], "select * from stdevice 
		...
		<td><?php
			...
			<td><?php
			   $device_query1 = mysqli_query($GLOBALS["___mysqli_ston"], "select * from stdevice ")or die(mysqli_error($GLOBALS["___mysqli_ston"]));
			...
			<td><button id="delete" onclick = "confirm('Apakah mau diDelete ?')" data-placement="left" title="Click to delete" name="delete" type="submit" class="btn btn-danger" value="<?php echo $id; ?>"><i class="icon-trash icon-large"></i> Delete</button></td>
	...
	<?php } ?>   
		...
		<?php if(isset($_POST['delete'])){
			$A = $_POST['delete'];
			mysqli_query($GLOBALS["___mysqli_ston"], "delete from `stdevice` where `id` = '$A' ")or die(mysqli_error($GLOBALS["___mysqli_ston"]));
		} ?>
