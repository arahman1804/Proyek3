            ...
            <div class="row-fluid">
			 <?php include('dashboard_slidebar.php'); ?>		
                <div class="span9" id="content">
                    <div class="row-fluid">
         	         <?php $query= mysqli_query($GLOBALS["___mysqli_ston"], "select * from admin where admin_id = '$session_id'")or die(mysqli_error($GLOBALS["___mysqli_ston"]));
                    ...
                    <div class="col-lg-12">
                      <div class="alert alert-success alert-dismissable">
                        ...
                        <div id="block_bg" class="block">
                           ...
                           <?php 
								$stocks = mysqli_query($GLOBALS["___mysqli_ston"], "select * from stdevice
								LEFT JOIN device_name ON stdevice.dev_id=device_name.dev_id")or die(mysqli_error($GLOBALS["___mysqli_ston"]));
								...
								<?php 
								$new = mysqli_query($GLOBALS["___mysqli_ston"], "select * from stdevice 
								LEFT JOIN device_name ON stdevice.dev_id=device_name.dev_id
								where dev_status = 'New' ORDER BY stdevice.id DESC")or die(mysqli_error($GLOBALS["___mysqli_ston"]));
								...
								<?php 
								$damage = mysqli_query($GLOBALS["___mysqli_ston"], "select * from stdevice 
								LEFT JOIN device_name ON stdevice.dev_id=device_name.dev_id
								where dev_status = 'damage' OR dev_status = 'Damage' ORDER BY stdevice.id DESC")or die(mysqli_error($GLOBALS["___mysqli_ston"]));
								...
								<?php 
								$device_location = mysqli_query($GLOBALS["___mysqli_ston"], "select * from location_details")or die(mysqli_error($GLOBALS["___mysqli_ston"]));
								...
								<?php 
								$keyboard = mysqli_query($GLOBALS["___mysqli_ston"], "select * from stdevice 
								LEFT JOIN device_name ON stdevice.dev_id=device_name.dev_id
			                    ...
			                    OR dev_name = '(kbrd)' ")or die(mysqli_error($GLOBALS["___mysqli_ston"]));
								...
								<?php 
								$Mouse = mysqli_query($GLOBALS["___mysqli_ston"], "select * from stdevice 
								LEFT JOIN device_name ON stdevice.dev_id=device_name.dev_id
			                    ...
			                    OR dev_name = 'Mouse-PS2' OR dev_name = 'Mouse-USB' OR dev_name = 'Mouse PS2' OR dev_name = 'Mouse USB' 
			                    ORDER BY stdevice.id DESC")or die(mysqli_error($GLOBALS["___mysqli_ston"]));
								...
								<?php 
								$Monitor = mysqli_query($GLOBALS["___mysqli_ston"], "select * from stdevice 
								LEFT JOIN device_name ON stdevice.dev_id=device_name.dev_id
								where dev_name = 'Monitor' OR dev_name = 'monitor'
			                     ...
			                     OR dev_name = '(monitor)' OR dev_name = '(montor)' ")or die(mysqli_error($GLOBALS["___mysqli_ston"]));
								...
								<?php 
								$CPU = mysqli_query($GLOBALS["___mysqli_ston"], "select * from stdevice 
								LEFT JOIN device_name ON stdevice.dev_id=device_name.dev_id
			                    ...
			                    OR dev_name = '(CPU)' OR dev_name = '(Central Processing unit (CPU))' ")or die(mysqli_error($GLOBALS["___mysqli_ston"]));
								...
								<?php 
								$power_supply = mysqli_query($GLOBALS["___mysqli_ston"], "select * from stdevice 
								LEFT JOIN device_name ON stdevice.dev_id=device_name.dev_id
								...
								OR dev_name = '(power-supply)' OR dev_name = 'POWER SUPPLY' ")or die(mysqli_error($GLOBALS["___mysqli_ston"]));
								...
								<?php 
								$vga = mysqli_query($GLOBALS["___mysqli_ston"], "select * from stdevice 
								LEFT JOIN device_name ON stdevice.dev_id=device_name.dev_id
			                    ...
			                    OR dev_name = 'vedeo graphic' OR dev_name = 'video graphic accelerator'")or die(mysqli_error($GLOBALS["___mysqli_ston"]));
								...
								<?php 
								$power_cords = mysqli_query($GLOBALS["___mysqli_ston"], "select * from stdevice 
								LEFT JOIN device_name ON stdevice.dev_id=device_name.dev_id
								...
								OR dev_name = 'powe cor'  OR dev_name = 'power-cord'")or die(mysqli_error($GLOBALS["___mysqli_ston"]));
