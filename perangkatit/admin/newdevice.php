                 ...
                 ?>                                               
                   <div id="block_bg" class="block"> 
                        <div class="navbar navbar-inner block-header"> 
                             <div class="muted pull-left"><i class="icon-check"></i>&nbsp;Device Stock List</div> 
                             <div class="muted pull-right"> 
                                Number of Device Stock (s): <span class="badge badge-info"><?php  echo $count; ?></span> 
                             </div> 
                          </div> 
...
<!-----------------------------------Content------------------------------------> 
        ...
        where NOT EXISTS  
       (select * from location_details where stdevice.id = location_details.id) 
        and dev_status='new' ORDER BY stdevice.id DESC") or die(mysqli_error($GLOBALS["___mysqli_ston"])); 
