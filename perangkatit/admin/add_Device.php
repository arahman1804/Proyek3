		                                 ...
		                                 <label class="control-label" for="inputEmail">Device Name</label>
			                                <div class="controls">
				                              <select name="dev_id" class="chzn-select"  required/>
				                                 <option></option>
			                                     <?php $device_name=mysqli_query($GLOBALS["___mysqli_ston"], "select * from device_name")or die(mysqli_error($GLOBALS["___mysqli_ston"])); 
...
mysqli_query($GLOBALS["___mysqli_ston"], "insert into stdevice (dev_id,dev_desc,dev_serial,dev_brand,dev_model,dev_status) values('$dev_id','$dev_desc','$dev_serial','$dev_brand','$dev_model','$dev_status')")or die(mysqli_error($GLOBALS["___mysqli_ston"]));
mysqli_query($GLOBALS["___mysqli_ston"], "insert into activity_log (date,username,action) values(NOW(),'$admin_username','Add device Detail id $dev_id')")or die(mysqli_error($GLOBALS["___mysqli_ston"]));											
?>
<script>
window.location = "device_stocks.php";
